    ...
    <div className="domain-details container py-5">
      <div className="row">
        <div className="col-12">
          <h1 className="domain-title text-center mb-4">{data.domainName}</h1>
          ...
          <div className="about-domain">
            <h2 className="section-heading mb-3">About {data.domainName}</h2>
            {data.domainDescription.map((paragraph, index) => (
          ...
          <div className="related-fields mb-5">
            ...
            <ul className="fields-list list-unstyled row">
              {data.relatedFields.map((field, index) => (
